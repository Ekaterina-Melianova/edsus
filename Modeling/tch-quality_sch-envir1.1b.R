...
MATH ~ f*Student_Attitudes + BSBGHER 
...
# Run Lavaan:
fit_sem1 <- sem(sem, data = stu_sus_timss, std.lv = T, sampling.weights = 'TOTWGT')
summary(fit_sem1, fit.measures = T, standardized = T)
...
MATH ~ c(f1, f2)*Student_Attitudes + BSBGHER 
...
# By groups
fit_sem_multi1 <- sem(sem_multi, data = stu_sus_timss, std.lv = T, sampling.weights = 'TOTWGT',
                          group = 'traditional_style', meanstructure = TRUE)
summary(fit_sem_multi1 , fit.measures = T, standardized = T)
...
# By groups
fit_sem_multi_plot1 <- sem(sem_multi_plot, data = stu_sus_timss, std.lv = T, sampling.weights = 'TOTWGT',
                      group = 'traditional_style', meanstructure = TRUE)
summary(fit_sem_multi_plot1 , fit.measures = T, standardized = T)
...
fit_sem_2.1 <- sem(sem_2.1, data = stu_sus_timss, std.lv = T, sampling.weights = 'TOTWGT',
                   group = 'traditional_style')
anova_res2.1 <- anova(fit_sem_multi1, fit_sem_2.1)


# Safety -> Student_Attitudes -> MATH
sem_3.1 <- paste0(cfa_higher, formative,'
...
fit_sem_3.1 <- sem(sem_3.1, data = stu_sus_timss, std.lv = T, sampling.weights = 'TOTWGT',
                   group = 'traditional_style')
anova_res3.1 <- anova(fit_sem_multi1, fit_sem_3.1)


# Conditions -> Student_Attitudes -> MATH
sem_4.1 <- paste0(cfa_higher, formative,
'
# Regressions
...
fit_sem_4.1 <- sem(sem_4.1, data = stu_sus_timss, std.lv = T, sampling.weights = 'TOTWGT',
                   group = 'traditional_style')
anova_res4.1 <- anova(fit_sem_multi1, fit_sem_4.1)


# n_tech -> Student_Attitudes -> MATH
sem_5.1 <- paste0(cfa_higher, formative,'
# Regressions
...
fit_sem_5.1 <- sem(sem_5.1, data = stu_sus_timss, std.lv = T, sampling.weights = 'TOTWGT',
                   group = 'traditional_style')
anova_res5.1 <- anova(fit_sem_multi1, fit_sem_5.1)
